...
export EDITOR=vi
export PATH=$PATH:~/.local/bin:~/.dotnet/tools
...
export PATH=$PATH:/home/dans/.gem/ruby/2.5.0/bin

export FZF_CTRL_T_OPTS="--preview '(highlight -O ansi -l {} 2> /dev/null || cat {} || tree -C {}) 2> /dev/null | head -200'"
[ -f ~/.fzf.zsh ] && source ~/.fzf.zsh
alias tmux='tmux -u'
alias nuget='mono ~/.local/bin/nuget.exe'
alias docfx='mono ~/docfx/docfx.exe'
alias htop='htop --delay 50'
alias mount-x='sudo ~/.local/bin/mount-x.sh'
...
export DotnetWorkerPath=~/Microsoft.Spark.Worker
